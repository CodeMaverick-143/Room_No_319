...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    ...
    outline: 'bg-transparent border border-primary-500 text-primary-400 hover:bg-primary-500/10 focus:ring-primary-200',
    ghost: 'bg-transparent hover:bg-dark-800 text-dark-300 focus:ring-dark-200',
